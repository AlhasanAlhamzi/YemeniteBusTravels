...
<div id="updateaccount" ><!--class="modal fade" role="sdialog">-->
  ...
  <form action='' method='POST' class='signupform' enctype="multipart/form-data">
    <!-- Modal content-->
          ...
          $query=mysqli_query($con,"select * from accounts where id=".$_POST['acc_id']);
          $data=mysqli_fetch_assoc($query);
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" onclick="document.location='admins.php?showtype=accounts';">&times;</button>
  ...
  <select class="form-control" name='adminupdatetype' id="sel1">
    ...
    <label >Date: <?php echo $data['dates']; ?></label><br/>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-danger" onclick="document.location='admins.php?showtype=accounts';" >Close</button>
      </div>
    </div>
